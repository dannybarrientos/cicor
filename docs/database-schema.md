...
```bash
# Levantar port-forwards de BD (un comando por módulo)
kubectl port-forward svc/cicor-commercial-db-svc  5431:5432 -n cicor-commercial &
kubectl port-forward svc/cicor-inventory-db-svc   5432:5432 -n cicor-inventory &
kubectl port-forward svc/cicor-accounting-db-svc  5433:5432 -n cicor-accounting &
kubectl port-forward svc/cicor-operations-db-svc  5434:5432 -n cicor-operations &
kubectl port-forward svc/cicor-hr-db-svc          5435:5432 -n cicor-hr &
