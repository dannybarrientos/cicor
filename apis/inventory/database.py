# ============================================================
# CICOR ERP - Inventory API | database.py
...
class DatabaseSettings(BaseSettings):
    ...
    postgres_db: str = "cicor_inventory_db"
    ...
    def dsn(self) -> str:
        return (
            ...
            f"application_name=cicor-inventory-api"
        )
...
def check_db_health() -> bool:
    ...
    Usado por los endpoints GET /health/ready y /health/startup."""
    try:
        with get_db_cursor() as cursor:
